...
if (isset($_POST["next"])) {
    ...
    if (($file_size > 10097152)){
        $imageErr = "Maximum size to upload a file is 10 MB";
    }


    // Term validation 
    if (empty($term)) {
        $termErr = "This field is required.";
    } 
    ...
    if ($imageErr === "" && $termErr === "") 
    {
        ...
        if ($ext == "doc" || $ext == "pdf"){
          ...
          setcookie('file',$fname,time()+3600*24);
          setcookie('file2',$fn,time()+3600*24);
            ...
            $imageErr = "Please Select  file  doc or pdf";
        }
                ...
                <div class="container h-100">
                  <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="card-body p-5">
                      ...
                      <div class="form-outline mb-4">
                     <textarea  id="" class="form-control form-control-lg" rows="10" name="" >
                      ...
                      <div class="form-outline mb-4">
                        <div class="pt-1 mb-4">
                        <input class="" type="checkbox" name="term" >&nbsp; Agree Terms and Condition
                        <small id="err" class="form-text text-danger"><?php echo $termErr; ?></small>
                        </div>
                        </div>
